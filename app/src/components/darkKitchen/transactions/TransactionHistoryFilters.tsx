...
import {
    TRANSACTION_HISTORY_DATE_PRESETS,
    TRANSACTION_TYPE_LABELS,
    type TransactionHistoryDatePreset,
...
interface Props {
    ...
    onDatePresetChange: (preset: TransactionHistoryDatePreset) => void
}
        ...
        >
            ...
            <div className="mb-4">
                ...
                <div className="flex flex-wrap gap-2">
                    {TRANSACTION_HISTORY_DATE_PRESETS.map(preset => (
                        <motion.button
                            key={preset.id}
                            type="button"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
                ...
                <div>
                    ...
                    >
                        ...
                        <option value="E">{TRANSACTION_TYPE_LABELS.E}</option>
                        <option value="I">{TRANSACTION_TYPE_LABELS.I}</option>
                    </select>
                </div>
                <div>
